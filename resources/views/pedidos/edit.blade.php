                ...
                <div class="form-group">
                    ...
                    <select name="id_fornecedor" id="id_fornecedor" class="form-control" required>
                        ...
                        @foreach($fornecedores as $fornecedor)
                            <option value="{{ $fornecedor->id }}" {{$pedido->id_fornecedor == $fornecedor->id ? 'selected' : ''}}>{{ $fornecedor->razao_social }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="form-group">
                    ...
                    <select name="id_produto" id="id_produto" class="form-control" required>
                        ...
                        @foreach($produtos as $produto)
                            <option value="{{ $produto->id }}" {{$pedido->id_produto == $produto->id ? 'selected' : ''}}>{{ $produto->descricao }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <select name="id_motorista" id="id_motorista" class="form-control">
                        ...
                        @foreach($motoristas as $motorista)
                            <option value="{{ $motorista->id }}" {{$pedido->id_motorista == $motorista->id ? 'selected' : ''}}>{{ $motorista->nome }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="form-group">
                    ...
                    <select name="id_caminhao" id="id_caminhao" class="form-control">
                        ...
                        @foreach($caminhoes as $caminhao)
                            <option value="{{ $caminhao->id }} {{$pedido->id_caminhao == $caminhao->id ? 'selected' : ''}}">{{ $caminhao->descricao }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="form-group">
                    <label for="pago">Pago</label>
                    <input type="checkbox" {{$pedido->pago ? 'checked' : ''}} value="1" name="pago" id="pago">
                </div>
                <div class="form-group">
                    <label for="data_entrega">Data de Entrega</label>
                    <input type="date" name="data_entrega" value="{{$pedido->data_entrega}}" class="form-control">
                </div>
                <div class="row">
